...
def initialize_parameters():
    ...
    W4 = tf.get_variable("W4", [3, 3, 16, 34], initializer = tf.contrib.layers.xavier_initializer(seed = 0))
...
def forward_propagation(X, parameters):
    ...
    P2 = tf.nn.max_pool(A4, ksize = [1,4,4,1], strides = [1,4,4,1], padding = 'SAME')
...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.001, num_epochs = 1, minibatch_size = 16, print_cost = True):
    """
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, "D:\\Personal\\ITM\\Diplomado Deep Learning\\RedesConvolucionales_Clase1_empty//model_softmax_mnist.ckpt")
